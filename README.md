# Практическая работа по Датам и Строкам
...
Установите зависимости через `npm i` в консоли и приступайте к заданиям.
...
#### Основные (0 - 12 баллов)

<<<<<<< HEAD
- до двенадцати баллов можно получить за прохождение автотестов
=======
-   до двенадцати баллов можно получить за прохождение автотестов
>>>>>>> 5aa9d627f2e35a11fb11d0cb7ffc039ac0f54b0e
